      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6 text-gray-900 dark:text-gray-100">
            ...
            @if(session('success'))
              <div class="border-gray-300 dark:border-gray-700 dark:bg-green-900 dark:text-gray-30 bg-opacity-80 rounded-md mb-3 py-2 px-2">
                <p>{{ session('success') }}</p>
              </div>
              @endif
              ...
              @if(session('failure'))
              <div class="border-gray-300 dark:border-gray-700 dark:bg-red-900 dark:text-gray-30 bg-opacity-80 rounded-md mb-3 py-2 px-2">
                <p>{{ session('failure') }}</p>
              </div>
              @endif


              <form method="post" wire:submit="save" enctype="multipart/form-data" class="flex gap-3 flex-col">
                @csrf
